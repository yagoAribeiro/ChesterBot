...
export class EmbedInstance {
    ...
    build(owner: string): EmbedBuilder {
        ...
        embed.setDescription(this.instance.itemRef.effect ?? this.instance.itemRef.description);
        if (this.instance.itemRef.effect) embed.addFields({ name: '\u200B', value: `*${this.instance.itemRef.description}*` });
